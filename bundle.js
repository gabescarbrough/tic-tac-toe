...
/***/ function(module, exports, __webpack_require__) {
	...
	var onChangePassword = function onChangePassword(event) {
	  ...
	  var data = getFormFields(this);
	  event.preventDefault();
	  api.changePassword(data, app).done(ui.success).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameCreateSuccess = function gameCreateSuccess(data) {
	  console.log(data);
	  app.game = data.game;
	};
	...
	var signInSuccess = function signInSuccess(data) {
	  ...
	  $('.welcome').hide();
	  $('.board').show();
	  gameAPI.createGame().done(gameCreateSuccess).fail(failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var makeBoardArray = function makeBoardArray() {
	  var currentBoard = [];
	...
	var checkWinArrayHorizontal = function checkWinArrayHorizontal() {
	  var testBoard = makeBoardArray(currentPlayer);

	  if (testBoard[0] === currentPlayer && testBoard[1] === currentPlayer && testBoard[2] === currentPlayer || testBoard[3] === currentPlayer && testBoard[4] === currentPlayer && testBoard[5] === currentPlayer || testBoard[6] === currentPlayer && testBoard[7] === currentPlayer && testBoard[8] === currentPlayer) {
	    if (currentPlayer === "x") {
	      ui.showXWinMessage();
	    } else {
	      ui.showOWinMessage();
	...
	var checkWinArrayVertical = function checkWinArrayVertical() {
	  var testBoard = makeBoardArray(currentPlayer);

	  if (testBoard[0] === currentPlayer && testBoard[3] === currentPlayer && testBoard[6] === currentPlayer || testBoard[1] === currentPlayer && testBoard[4] === currentPlayer && testBoard[7] === currentPlayer || testBoard[2] === currentPlayer && testBoard[5] === currentPlayer && testBoard[8] === currentPlayer) {
	    if (currentPlayer === "x") {
	      ui.showXWinMessage();
	    } else {
	      ui.showOWinMessage();
	...
	var checkWinArrayDiagonal = function checkWinArrayDiagonal() {
	  var testBoard = makeBoardArray(currentPlayer);

	  if (testBoard[0] === currentPlayer && testBoard[4] === currentPlayer && testBoard[8] === currentPlayer || testBoard[2] === currentPlayer && testBoard[4] === currentPlayer && testBoard[6] === currentPlayer) {
	    if (currentPlayer === "x") {
	      ui.showXWinMessage();
	    } else {
	      ui.showOWinMessage();
	...
	var resetBoard = function resetBoard() {
	  ...
	  gameAPI.createGame().done(ui.gameCreateSuccess).fail(ui.failure);

	  gameAPI.getGames().done(ui.getGamesSuccess).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showXWinMessage = function showXWinMessage() {
	  // $(".board").hide();
	  $(".win-message").append("<h1>X wins!</h1>");
	};

	var showOWinMessage = function showOWinMessage() {
	  // $(".board").hide();
	  $(".win-message").append("<h1>O wins!</h1>");
	};

	var showTieMessage = function showTieMessage() {
	  // $(".board").hide();
	...
	module.exports = {
	  showXWinMessage: showXWinMessage,
	  showOWinMessage: showOWinMessage,
	  showTieMessage: showTieMessage,
